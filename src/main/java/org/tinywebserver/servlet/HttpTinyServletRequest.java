...
public class HttpTinyServletRequest implements TinyServletRequest {
  ...
  private static final Logger log = Logger.getLogger(HttpTinyServletRequest.class);
  ...
  public void readRequest() throws IOException {
    ...
    if (request == null) throw new IOException("Null request line");
  ...
  protected void parseMethod(String requestLine) {
    ...
    if (method.equals(METHOD_GET)) this.method = METHOD_GET;
    else if (method.equals(METHOD_POST)) this.method = METHOD_POST;
  ...
  protected void parseRequest(String requestLine) throws UnsupportedEncodingException {
    ...
    if (queryString != null) parseQueryString(queryString);
  }
  ...
  public Map<String, String> getCookies() throws IOException {
    ...
    if (cookieKeyValueLine == null) return new HashMap<String, String>();
  ...
  public TinyHttpSession getSession() throws IOException {
    ...
    String sessionId =
        TinyServletConfig.getTinyServletConfigInstance().getProperty(TINYWEBSERVER_SESSION_COOKIE);
