...
public class TinyServletHandler {
  ...
  public void processTinyServlet(
      TinyServlet tinyServlet,
      HttpTinyServletRequest httpTinyServletRequest,
  ...
  void addCookieHeaders(HashMap<String, String> responseCookies, PrintWriter output) {
